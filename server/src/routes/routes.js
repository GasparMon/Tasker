...
routes.put("/updateNotifications/:id", updateNotification_1.default);
...
routes.put("/addNewUserBoard", addNewUserBoard_1.default);
routes.put("/putUserTeamResponse", putUserTeamResponse_1.default);
