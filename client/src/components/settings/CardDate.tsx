...
const CardDate: React.FC<PropsStatus> = ({ handleClose }) => {
  ...
  return (
    <div className="absolute w-[300px] h-[130px] bg-white top-[235px] right-[-92px] border-gray-100 rounded-[10px] border-[1px] shadow-sm shadow-black/10">
      ...
      <div className="w-full h-[230px] grid grid-rows-5 gap-[4px] py-[8px] mt-[5px] items-center justify-center">
        <input
          className="w-[190px] h-[50px] text-[18px] border-[2px] border-sky-500 rounded-[15px] px-[10px]"
          type="date"
          id="fecha"
          name="date"
          value={date.date}
