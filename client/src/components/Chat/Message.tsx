...
const Message: React.FC<Message> = ({ author, message, time, userId, room }) => {
        ...
        {room === IdRoom ? (
          user.id === userId ? (
            <div className=" relative w-full min-h-[100px] mt-[10px] flex flex-col justify-center">
              ...
              <div className=" relative min-h-[60px] w-[70%] bg-indigo-500 ml-[100px] rounded-t-[25px] rounded-br-[25px] flex items-center px-[25px] py-[5px] shadow-md shadow-black/20">
            ...
            <div className=" relative w-full min-h-[100px] flex flex-col items-end justify-center">
              ...
              <div className="relative min-h-[60px] w-[70%] bg-cyan-600 mr-[100px] rounded-t-[25px] rounded-bl-[25px] flex items-center px-[25px] py-[5px] shadow-md shadow-black/20">
                <h1 className="text-white font-light text-[16px]">{message}</h1>
                <div className="absolute bottom-[-22px] right-[0px] w-[180px] h-[20px]">
